		...
		<ul class="nav metismenu" id="side-menu">
			<li class="nav-header">
				<div class="dropdown profile-element"> <span>
					<img alt="image" class="img-circle" src="{{ URL::asset('images/profile_small.jpg') }}" />
					 </span>
			...
			<li class="active">
				...
				<ul class="nav nav-second-level">
					<li class="active"><a href="/admin/index">Dashboard v.1</a></li>
			...
			<li>
				<a href="#"><i class="fa fa-sitemap"></i> <span class="nav-label">{{ trans('leftnav.user-manager') }}</span><span class="fa arrow"></span></a>
				<ul class="nav nav-second-level collapse">
					<li>
						<a href="#" id="damian">{{ trans('leftnav.role-manager') }}<span class="fa arrow"></span></a>
						<ul class="nav nav-third-level">
							<li>
								<a href="/admin/role-list">{{ trans('leftnav.role-list') }}</a>
							</li>
							<li>
